...
class SensorSplitter(QSplitter):
    ...
    def setup_layout(self):
        ...
        self.layout_func.addWidget(self.sensor_choice)
    ...
    def connect_function(self):
        ...
        self.buildScene.pressed.connect(lambda: self.functions.buildScene())
        self.sensor_start.pressed.connect(lambda: self.functions.startSensor())
        self.sensor_update.pressed.connect(lambda: self.functions.updateCal())
